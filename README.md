...
To build the final jar and optimize the demolog application for production, run:
...
If you want to deploy this application to kubernetes using 
the pre-built image (from dockerhub) execute:
